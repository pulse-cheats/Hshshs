--[[
    DARKDEV GREEK RP - ULTIMATE MASTER SUITE v33.0 (XENO EXECUTOR COMPATIBLE)
...
local SafeGuiParent = (gethui and gethui()) or (game:GetService("CoreGui")) or LP:WaitForChild("PlayerGui")
local SG = Instance.new("ScreenGui")
SG.Name = "DarkDev_v33_Xeno"
...
-- --- CORE ESP & GAME LOOPS (XENO DRAWING SAFE) ---
local ESP_Objects = {}
local HasDrawing = pcall(function() return Drawing and Drawing.new end) and Drawing ~= nil
...
print("DarkDev Xeno Compatible Suite v33.0 Loaded Successfully!")
